...
1. **Matriz de aceptación (Sección 4 de CONTINUIDAD):** continuar los 14 puntos de prueba manual con dos correos y dos organizaciones en el entorno desplegado. Los puntos 1-9 y 11 quedaron superados el 14/08/2026 (registro de A, Organización A, recuperación de contraseña, subida/descarga de archivos y PDF, invitación al Usuario B, rol `lectura` comprobado, ascenso a `miembro`, Organización B homónima sin fuga de datos y cookies HttpOnly/Secure).
...
3. **E1W-007 / E1W-008:** las invitaciones de equipo, el cambio de roles (`lectura` vs `miembro`) y las cookies de sesión (HttpOnly/Secure/SameSite, `document.cookie` vacío) ya quedaron validados en navegador real el 14/08/2026 (puntos 6-8 y 11 de la matriz). Queda validar la ausencia de violaciones CSP en navegador real HTTPS (punto 12). La recuperación de clave ya está validada.
