...
1. **Matriz de aceptación (Sección 4 de CONTINUIDAD):** continuar los 14 puntos de prueba manual con dos correos y dos organizaciones en el entorno desplegado. Los puntos 1-8 quedaron superados el 14/08/2026 (registro de A, Organización A, recuperación de contraseña, subida/descarga de archivos y PDF, invitación al Usuario B, rol `lectura` comprobado y ascenso a `miembro`).
