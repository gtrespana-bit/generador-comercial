...
1. **Matriz de aceptación (Sección 4 de CONTINUIDAD):** continuar los 14 puntos de prueba manual con dos correos y dos organizaciones en el entorno desplegado. Los puntos 1-9 quedaron superados el 14/08/2026 (registro de A, Organización A, recuperación de contraseña, subida/descarga de archivos y PDF, invitación al Usuario B, rol `lectura` comprobado, ascenso a `miembro` y Organización B homónima sin fuga de datos).
...
3. **E1W-007 / E1W-008:** las invitaciones de equipo y el cambio de roles (`lectura` vs `miembro`) ya quedaron validados en navegador real el 14/08/2026 (puntos 6-8 de la matriz). Queda validar la interacción de cookies/CSP en navegador real HTTPS (puntos 11 y 12). La recuperación de clave ya está validada.
