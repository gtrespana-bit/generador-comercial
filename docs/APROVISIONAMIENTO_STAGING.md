...
| `/readyz` | Readiness: Auth, Storage, COTIZAT_PUBLIC_URL, conexión PostgreSQL, head de Alembic (`f9f24d062470`) y rol runtime (miembro de `cotizat_app`, `NOSUPERUSER`, `NOBYPASSRLS`, `INHERIT`). |
...
alembic current          # antes: d7f2a9c41e63 (conocido) o inferior
alembic upgrade head
alembic current          # OBLIGATORIO que imprima: f9f24d062470
