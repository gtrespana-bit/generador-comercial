...
La revisión `9bca2ad1f6e4`, que añade el vínculo con Supabase Auth, también quedó aplicada en el mismo proyecto. El head vigente allí sigue siendo `9bca2ad1f6e4`. El código tiene como head `f9f24d062470`: encadena Storage privado, invitaciones, las políticas RLS/rol de aplicación, la corrección de visibilidad de la invitación aceptada y la legibilidad de `public.alembic_version` para el rol runtime. Esas revisiones siguen pendientes de aplicar y probar en el entorno real.
